...
export default function Hero() {
  return (
    <div className="mt-14 w-full px-7 sm:mt-44 sm:max-w-(--breakpoint-xl)">
      <div className="sm:flex">
        <div className="sm:w-1/2">
          <div className="w-fit lg:flex">
            <div className="bg-primary-50 text-primary-700 ring-primary-700/10 flex w-fit items-center rounded-full py-2 pr-3 pl-2 text-sm font-medium shadow-sm ring-1 ring-inset">
              <div className="bg-primary-500 rounded-full px-2 py-0.5 text-white">NEW</div>
              <div className="ml-3">
                Free to use and{" "}
            ...
            <Button
              ...
              target="_blank"
              className="mt-2 w-full rounded-full border-[#b39b03] bg-[#ffdd04] font-bold sm:w-48 lg:mt-0 lg:ml-2">
          ...
          <div className="mt-6 sm:mt-10">
            <h2 className="text-neutral-500 sm:text-lg">
              <span className="font-logo text-logo font-medium">exifoo</span> helps you keep your photos and
